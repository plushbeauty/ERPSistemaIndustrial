...
const missingConfigClient = new Proxy({} as SupabaseClient, { get() { throw new Error('SUPABASE_CONFIG_MISSING: configure VITE_SUPABASE_URL and VITE_SUPABASE_PUBLISHABLE_KEY in Vercel') } })
