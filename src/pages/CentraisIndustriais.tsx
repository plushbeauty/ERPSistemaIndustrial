...
export default function CentraisIndustriais({module}:{module:Module}){
 ...
 const title={financeiro:'Central Financeira',expedicao:'Expedição e Logística',metrologia:'Metrologia e Calibração',treinamentos:'Treinamentos e Competências',auditoria:'Auditorias e Conformidade',paradas:'Paradas, Setup e Downtime',refugos:'Refugo e Retrabalho'}[module]
