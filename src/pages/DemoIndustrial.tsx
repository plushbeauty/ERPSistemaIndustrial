...
function Panel({title,subtitle,children}:{title:string;subtitle:string;children:ReactNode}){return <section className="industrial-panel"><header><div><span>CONTROLE</span><h2>{title}</h2><p>{subtitle}</p></div></header>{children}</section>}
