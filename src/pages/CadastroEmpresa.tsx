...
const FUNCTION_URL = 'https://wdkvrqekixczuhrfygen.supabase.co/functions/v1/erp-company-signup'
...
export default function CadastroEmpresa(){
  ...
  async function cadastrar(e:FormEvent){
    ...
    setLoading(true)
    try{
      const r=await fetch(FUNCTION_URL,{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({razao_social:razao,nome_fantasia:fantasia,email,nome_admin:nomeAdmin,senha,nome_acesso:acesso})})
